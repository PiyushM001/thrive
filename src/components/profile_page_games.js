...
<div className='bg-[#090909] h-[3rem] flex  items-center justify-center'>
  <div className='bg-[#090909] w-[90%] h-[2rem] flex justify-evenly'>
    ...
    <Link className='border-r-[2px]  border-[#222222] border-b-[2px] border-b-[#B4FF16] shadow-b-inner shadow-[#B4FF16] w-full flex justify-center items-center' to='/profile/Games'> <div className=' w-full flex justify-center text-[#656565] text-[3.5vw]'>Games</div></Link> 
